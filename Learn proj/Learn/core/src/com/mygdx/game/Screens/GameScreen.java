...
/**
 * This is the Game Screen, shows the game and handle the user input
 */
public class GameScreen implements Screen {
    ...
    /**
     * Creates a bew Game Screen
     * @param app game application for getting the loaded textures
     * @param playerCar car chosen in the previous screens
     * @param t track chosen in the previous screens
     */
    public GameScreen(MyGdxGame app, Sprite playerCar, Track t) {
        this.app = app;
        sprite = playerCar;
        track = t;
    }
    ...
    /**
     * Handles the user input while the game is not paused
    ...
    /**
     * Handles the user input while the game is paused
     * @param batch
     */
    ...
    /**
     * Recognizes multiple touches in the screen
     * @param x1
     * @param x2
     * @param y1
     * @param y2
    ...
    /**
     * Updates the Textures for the display of the current lap
     */
